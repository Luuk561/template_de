                ...
                <li>
                    ...
                    <div class="info-submenu" style="max-height: 0; overflow: hidden; transition: max-height 0.3s ease; margin-top: 8px;">
                        @foreach($informationPages as $page)
                            <a href="{{ route('informatie.show', $page->slug) }}" class="block py-3 px-6 text-sm transition-colors" style="color: rgba(255,255,255,0.9); background: rgba(255,255,255,0.05); border-radius: 12px; margin-bottom: 6px; padding-left: 3rem;">
